# Code Conventions — Signal Bot V1.3
...
❌ celery/  (V1.3 dùng FastAPI BackgroundTasks cho notify, chưa dùng queue)
❌ redis/   (V1.3 dùng DB cho cooldown/duplicate check; rate limit in-memory)
```
